        ...
        for pool, u in enumerate(e["units"]):
            ...
            for r in u["results"]:
                ...
                if bib not in ignore_bibs:
                     ...
                     scores.append( (competitors[bib][0], competitors[bib][1], event_code, gender, age, res, score, tyrving) )
            """
