def club_code(club_name):
    if club_name is None:
       ...
       club_code=u'BRYF'
    elif club_name in (u'BRYNE TRIATLONKLUBB', u'Bryne Triatlonklubb'):
       club_code=u'BRYT'
       ...
       club_code=u'FYLL'
    elif club_name in (u'Fyresdal Idrettslag'):
       club_code=u'FYRIL'
       ...
       club_code=u'GJVIK'
    elif club_name in (u'Glesnes Ungdoms Og Idrettslag', u'Glesnes UIL'):
       club_code=u'GLUIL'
       ...
       club_code=u'HAL'
    elif club_name in (u'Halden løpeklubb'):
       club_code=u'HALOP'
       ...
       club_code=u'HAUGF'
    elif club_name in (u'Haugesund Triathlon Klubb', u'Haugesund triatlonklubb'):
       club_code=u'HAUGT'
       ...
       club_code=u'HERY'
    elif club_name in (u'Hinna Friidrett', u'Hinna Idrettslag Friidrett'):
       club_code=u'HIN'
       ...
       club_code=u'HOB'
    elif club_name in (u'Hof Idrettslag', u'Hof Idrettslag (Arneberg)'):
       club_code=u'HOF'
       ...
       club_code=u'HOPE'
    elif club_name in (u'Hordabø Idrettslag'):
       club_code=u'HORDB'
       ...
       club_code=u'EXPR'
    elif club_name in (u'Idrettslaget Fenring'):
       club_code=u'ILFEN'
       ...
       club_code=u'ILROS'
    elif club_name in (u'Idrettslaget Runar', u'IL Runar', u'Runar Allianseidrettslag', u'Runar AIL'):
       club_code=u'RUNAR'
    elif club_name in (u'Idrettslaget Sand'):
       club_code=u'ILSAN'
    elif club_name in (u'Idrettslaget Sandvin', u'IL Sandvin'):
       club_code=u'SANDV'
    elif club_name in (u'Idrettslaget Sandviken'):
       club_code=u'SAVIK'
...
#      club_code=u'ILBUL'
       ...
       club_code=u'EIKKV'
    elif club_name in (u'Kalandseid Idrettslag'):
       club_code=u' KALIL'
       ...
       club_code=u'STKAM'
    elif club_name in (u'IL Tambarskjelvar', u'Tambarskjelvar Idrettslag'):
       club_code=u'TAMBA'
       ...
       club_code=u'VESTB'
    elif club_name in (u'Il Vindbjart', u'IL Vindbjart'):
       club_code=u'VIND'
       ...
       club_code=u'INN'
    elif club_name in (u'International School of Stavanger', u'International School Of Stavanger'):
       club_code=u'INSTA'
       ...
       club_code=u'KLIL'
    elif club_name in (u'Kolbukameratene I L', u'Kolbu KK'):
       club_code=u'KLBK'
       ...
       club_code=u'LILLS'
    elif club_name in (u'Lillomarka SkiKlubb', u'Lillomarka Skiklubb'):
       club_code=u'LILSK'
       ...
       club_code=u'LYNGO'
    elif club_name in (u'Lysekloster Idrettslag '):
       club_code=u'LYSIL'
       ...
       club_code=u'MELHU'
    elif club_name in (u'Midtbygdens Idrettslag'):
       club_code=u'MIDTB'
       ...
       club_code=u'MOITU'
    elif club_name in (u'Monolitten Idrettslag'):
       club_code=u'MONO'
       ...
       club_code=u'NANN'
    elif club_name in (u'Nanset Idrettsforening'):
       club_code=u'NANSE'
       ...
       club_code=u'NISS'
    elif club_name in (u'Nittedal Idrettslag', u'Nittedal IL', u'Nittedal Friidrett'):
       club_code=u'NITT'
       ...
       club_code=u'NORR'
    elif club_name in (u'Nordstrand Idrettsforening'):
       club_code=u'NORD'
       ...
       club_code=u'OGND'
    elif club_name in (u'Oksen Idrettslag'):
       club_code=u'OKSEN'
       ...
       club_code=u'OPSTR'
    elif club_name in (u'Opptur Motbakkeklubb', u'Opptur Løpeklubb'):
       club_code=u'OPPT'
       ...
       club_code=u'PORS'
    elif club_name in (u'Rakkestad Idrettsforening'):
       club_code=u'RAKKE'
       ...
       club_code=u'RING'
    elif club_name in (u'Risberget Idrettslag'):
       club_code=u'RISIL'
       ...
       club_code=u'ROSEN'
    elif club_name in (u'Royal Sport', u'Royal Sportsklubb'):
       club_code=u'ROYAL'
       ...
       club_code=u'SKO'
    elif club_name in (u'Skogsvåg Idrettslag'):
       club_code=u'SKOIL'
       ...
       club_code=u'SIL'
    elif club_name in (u'Sokndal Friidrettsklubb', u'Sokndal Idrettsklubb'):
       club_code=u'SOKND'
    elif club_name in (u'Sola Friidrett'):
       club_code=u'SOLA'
    elif club_name in (u'Solnut IL', u'I.l. Solnut'):
       club_code=u'SOLN'
       ...
       club_code=u'STOFJ'
    elif club_name in (u'Stovnerkameratene'):
       club_code=u'STOKA'
       ...
       club_code=u'SDAL'
    elif club_name in (u'Søreide Idrettslag'):
       club_code=u'SORIL'
       ...
       club_code=u'HOVD'
    elif club_name in (u'Tamil Sangam IL', u'Sangam Idrettslag'):
       club_code=u'TAMSAN'
       ...
       club_code=u'TOMR'
    elif club_name in (u'Toppen I.L'):
       club_code=u'TOPPIL'
       ...
       club_code=u'URFRI'
    elif club_name in (u'Uskedal Idrettslag'):
       club_code=u'USKIL'
       ...
       club_code=u'OTRET'
    elif club_name in (u'Øygarden Idrettslag'):
       club_code=u'OYIL'
...
def club_name(club_code):
    ...
    elif club_code == (u'HORDB'):
       club_name=u'Hordabø IL'
    ...
    elif club_code == (u'KALIL'):
       club_name=u'Kalandseid IL'
    ...
    elif club_code == (u'LYSIL'):
       club_name=u'Lysekloster IL'
    ...
    elif club_code == (u'SKOIL'):
       club_name=u'Skogsvåg IL'
    ...
    elif club_code == (u'OYIL'):
       club_name=u'Øygarden IL'
